...
sudo apt-get update && sudo apt-get upgrade -y \
  ...
  && sudo add-apt-repository ppa:ondrej/php ppa:openswoole/ppa -y \
  ...
  && sudo apt-get install php8.1-amqp php8.1-apcu php8.1-ast php8.1-bcmatch \
          ...
          php8.1-gmagick php8.1-gmp php8.1-imagick php8.1-mbstring php8.1-mcrypt\
          ...
          php8.1-gnupg php8.1-grpc php8.1-http php8.1-igbinary php8.1-inotify \
          php8.1-intl php8.1-ldap php8.1-lz4 php8.1-msgpack php8.1-pspell \
          php8.1-readline php8.1-soap php8.1-solr php8.1-swoole php8.1-openswoole \
          php8.1-tidy php8.1-uopz php8.1-xhprof -y \
